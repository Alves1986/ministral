        ...
        {logs.map((log, idx) => (
          <div key={log.id || idx} className="text-xs p-3 bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-700 rounded-lg flex flex-col gap-1">
            ...
            <div className="flex items-center gap-2">
                <span className="font-bold text-ministral-600 dark:text-ministral-400 uppercase tracking-wider text-[10px] bg-ministral-50 dark:bg-ministral-900/20 px-1.5 py-0.5 rounded">{log.action}</span>
            </div>
